-- This scripts manipulates originalsize and originalposition values inside of your character
-- This script is for r15
-- Use settings table to mess around with types of weird scaling
